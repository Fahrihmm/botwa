...
petik = '```'
fake = '©Recode By MuriOfficialXD'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "MuriOfficialXD️","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `©MuriOfficialXD`,"description": "ItsMeBotz", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "MuriOfficialXD","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
🌏 *INFO BOT* 🌏
ᱝ *Nama : Fahbotz*
ᱝ *Nomor :* @6283175816442
ᱝ *Owner : MuriOfficialXD* 
ᱝ *Aktif :* ${runtime(process.uptime())}
ᱝ *Prefix :* 『> ${prefix} <』

🖥️ *LIST '͊͊͊͊͋͋͋͋͋͋͋͋͋͋͋MENU* 🖥️
ᱝ *#Ownermenu*
ᱝ *#Groupmenu*
ᱝ *#Infomenu*
ᱝ *#Downloadmenu*
...
🌄 *INFO TODAY* 🌄
ᱝ *Pukul :* ${moment().utcOffset('+0700').format('HH:mm:ss')}
ᱝ *Tanggal :* ${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}
ᱝ *User :* ${pushname}

*Ada Bug?* ketik ${prefix}bugreport Ya!
*Request fitur?* Ketik ${prefix}owner Ya!
*Sewa bot?* Chat wa.me/6283175816442
┏━━━━━━━━━━━━━━━━━━
𝘘𝘜𝘖𝘛𝘌𝘚  : 
*${quotes}*

┗━━━━━━━━━━━━━━━━━━`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'MENU BANG🗿'},type:1},{buttonId: `${prefix}vn`,buttonText:{displayText: 'MENU VN🗣️'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'DONATE💸'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '©MuriOfficialXD', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               list = []
               listmenu = [`groupmenu`,`wibumenu`,`stickermenu`,`islammenu`,`sertimenu`,`ceritamenu`,`makermenu`,`dewasamenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`toolsmenu`,`botstat`]
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Dewasa Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`,`Status menu`]
               nombor = 1
               startnum = 0
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'MuriOfficialXD' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by MuriOfficialXD', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${ucapanWaktu}`,   `Subscribe https://youtube.com/fahrihmm`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
//------------------< Premium >-------------------
       ...
       case 'listpremium':          
              ...
              txt += `➸ *ID :* @${i.id.split("@")[0]}\n➸ *Expired*: ${checkExp.days} day(d) ${checkExp.hours} hour(h) ${checkExp.minutes} minute(m) ${checkExp.second} second(s)\n\n`
}
...
*▢️ ${prefix}premium add* _@tag|nomor_ (waktu)
*▢ ${prefix}premium del* _@tag|nomor_ (waktu)
*▢ ${prefix}setpp*
*▢ ${prefix}setbio*
*▢ ${prefix}setname*
*▢ ${prefix}getpp*
...
*Order Role? Bisa pake Gopay!*
*Chat Owner :* wa.me/6283175816442`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©MuriOfficialXD* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
"groupName": `MuriOfficialXD ~ 404 ${vipi}`,
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran MuriOfficialXD 」*\n#Ijin Siaran\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": 'Fahbotz ßð†z',
			"buttons": [
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6283175816442@s.whatsapp.net',`*info bug yaitu:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/MuriOfficialXD`)
             break
      case 'grupbot':
